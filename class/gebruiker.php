...
class gebruiker {
    ...
    public function getInfo($email){
            $qry_Select = "SELECT g.`id`, g.`email`, g.`wachtwoord`, g.`rolId`, g.`voornaam`, g.`tussenvoegsel`, g.`achternaam`, g.`telefoon`, g.`start_datum`, rol.naam AS rolName FROM gebruiker AS g INNER JOIN rol ON g.`rolId` = rol.id WHERE email = '$email'";
